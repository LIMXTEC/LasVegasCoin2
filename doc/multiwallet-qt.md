...
In order to support loading of multiple wallets in lasvegascoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lasvegascoin.cpp.
...
Changes to lasvegascoin.cpp
----------------------
lasvegascoin.cpp is the entry point into lasvegascoin-qt, and as such, will require some minor modifications to provide hooks for
