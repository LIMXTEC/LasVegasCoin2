...
*Setup instructions for a gitian build of VGS using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the VGS
...
- [Building VGS](#building-lasvegascoin)
...
To build VGS (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/LIMXTEC/Lasvegascoin
...
For example:
```bash
URL=https://github.com/LIMXTEC/Lasvegascoin
