 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called VGS (http://www.lasvegascoin.org),
 * which enables instant payments to anyone, anywhere in the world. VGS uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (mapArgs.count("-version")) {
            ...
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  lasvegascoind [options]                     " + _("Start Diamond Core Daemon") + "\n";
    ...
    try {
        ...
        if (fDaemon) {
            fprintf(stdout, "VGS server starting\n");
