Contributing to VGS Core
============================

The VGS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VGS Core project, and is not to be
confused with overall VGS Network Protocol consensus changes.

Whether a pull request is merged into VGS Core rests with the project merge
...
Patches that change VGS consensus rules are considerably more involved than
...
Where a patch set proposes to change the VGS consensus, it must have been
...
The project leader is the release manager for each VGS Core release.
